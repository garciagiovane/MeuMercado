    ...
    <div class="jumbotron">
      ...
      <div class="list-group">
        <ul class="nav justify-content-center">
          ...
          <li class="nav-item">
            <a class="list-group-item list-group-item-light" href="consulta-produtos.php">Consultar Produtos</a> 
          </li>
          <li class="nav-item">
            <a class="list-group-item list-group-item-light" href="#">Link</a>
          </li>
        </ul>
      </div>
    </div>
